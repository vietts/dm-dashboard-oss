...
function NarrativeCanvasInner({
  ...
  }, [selectedNodeId, selectedEdgeId, nodes, onDeleteNode, onDeleteEdge])
  ...
  }, [nodes, edges, onPositionUpdate, reactFlowInstance])
    ...
    >
      ...
      >
        ...
        <MiniMap
          ...
          className="!bg-[var(--cream-dark)] !border-2 !border-[var(--teal)] !rounded-lg"
        ...
        <Panel position="top-left" className="text-xs text-[var(--ink-light)] bg-[var(--paper)]/80 p-2 rounded-lg border border-[var(--ink-faded)]/20">
          <div className="flex flex-col gap-1">
            ...
            <div className="mt-1.5 pt-1.5 border-t border-[var(--ink-faded)]/20">
